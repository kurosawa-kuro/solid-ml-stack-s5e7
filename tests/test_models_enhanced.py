"""
Comprehensive test coverage for src/models.py
Targeting high-impact functions to improve coverage from 19% to 80%+
"""
...
class TestLightGBMModelCore:
    """Core LightGBMModel functionality tests"""
...
class TestCrossValidationTrainerCore:
    """Core CrossValidationTrainer functionality tests"""
...
class TestOptunaOptimizerCore:
    """Core OptunaOptimizer functionality tests"""
...
class TestUtilityFunctions:
    ...
    def test_create_learning_curve_data(self):
        ...
        train_scores = [0.85, 0.90, 0.93, 0.95]
        val_scores = [0.82, 0.87, 0.90, 0.92]
