...
Examples:
  ...
  python3 scripts/time_tracker_cli.py --clear data_processing     # Clear workflow data
    ...
    parser.add_argument("--stats", action="store_true", help="Show statistics for all workflows")

    parser.add_argument("--list", action="store_true", help="List all tracked workflows")

    parser.add_argument("--estimate", metavar="WORKFLOW", help="Get estimated duration for a workflow")

    parser.add_argument("--clear", metavar="WORKFLOW", help="Clear data for a specific workflow")
